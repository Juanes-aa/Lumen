...
async def test_add_watched_movie_success() -> None:
    app.dependency_overrides[get_supabase_user] = lambda: _mock_insert_success()
...
async def test_add_duplicate_movie_returns_409() -> None:
    app.dependency_overrides[get_supabase_user] = lambda: _mock_insert_duplicate()
...
async def test_get_watched_movies_returns_only_user_movies() -> None:
    ...
    app.dependency_overrides[get_supabase_user] = lambda: _mock_select([row])
...
async def test_delete_watched_movie_success() -> None:
    app.dependency_overrides[get_supabase_user] = lambda: _mock_delete([INSERTED_ROW])
...
async def test_delete_other_users_movie_returns_404() -> None:
    app.dependency_overrides[get_supabase_user] = lambda: _mock_delete([])
