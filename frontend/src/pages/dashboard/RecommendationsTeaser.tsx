...
function RecPreviewCard({ rec, onClick }: RecPreviewCardProps): React.ReactElement {
  return (
    <div
      ...
      tabIndex={0}
    >
      <p className="font-serif text-[15px] font-medium text-celuloide mb-[6px] leading-snug">
        {rec.title}
      </p>
      <p className="font-sans text-[11.5px] text-gray-mid leading-[1.55] mb-[10px] line-clamp-3">
        {rec.reason}
      </p>
...
export default function RecommendationsTeaser(): React.ReactElement {
  ...
  return (
    <div className="lumen-anim-5 flex flex-col gap-0">
      ...
      {topRec !== null ? (
        <div className="border-t-[0.4px] border-borde mt-5 pt-5">
